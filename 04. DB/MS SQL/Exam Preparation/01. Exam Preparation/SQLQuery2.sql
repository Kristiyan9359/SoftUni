...
-- PROBLEM 5 -- Bookings by Price of Room and Arrival Date
...
-- PROBLEM 6 -- Hotels by Count of Bookings
  ...
  SELECT 
    ...
    JOIN Bookings b ON h.Id = b.HotelId AND r.[Type] = 'VIP Apartment'
GROUP BY h.Id, h.Name
ORDER BY COUNT(*) DESC
;

-- PROBLEM 7 --	Tourists without Bookings
...
-- PROBLEM 8 --	First 10 Bookings
  ...
  SELECT TOP 10
    ...
    JOIN Destinations AS dst ON h.DestinationId = dst.Id
    JOIN Countries AS c ON dst.CountryId = c.Id
   WHERE b.ArrivalDate < '2023-12-31'
     AND b.HotelId % 2 <> 0    
ORDER BY c.[Name], b.ArrivalDate
;

-- PROBLEM 9 --	Tourists booked in Hotels
