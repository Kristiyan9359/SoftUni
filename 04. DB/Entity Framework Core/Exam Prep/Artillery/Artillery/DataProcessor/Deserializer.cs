namespace Artillery.DataProcessor
{
    ...
    public class Deserializer
    {
        ...
        public static string ImportCountries(ArtilleryContext context, string xmlString)
        {
            ...
            var countriesDto = XmlSerializerWrapper.Deserialize<CountryDto[]>(xmlString, "Countries");
        ...
        public static string ImportManufacturers(ArtilleryContext context, string xmlString)
        {
            ...
            var manufacturersDto = XmlSerializerWrapper.Deserialize<ManufacturerDto[]>(xmlString, "Manufacturers");
        ...
        public static string ImportShells(ArtilleryContext context, string xmlString)
        {
            ...
            var shellsDto = XmlSerializerWrapper.Deserialize<ShellDto[]>(xmlString, "Shells");
            ...
            foreach (var shellDto in shellsDto)
            {
                ...
                shells.Add(shell);
                sb.AppendLine(string.Format(SuccessfulImportShell, shell.ShellWeight, shell.Caliber));
            }
