...
-- PROBLEM 6 --	Sites with Their Location and Category
...
-- PROBLEM 7 --	Count of Sites in Sofia Province
...
SELECT 
 ...
 -- PROBLEM --	Tourist Sites established BC
...
-- PROBLEM 9 --	Tourists with their Bonus Prizes
...
LEFT JOIN BonusPrizes AS bp
 ...
 -- PROBLEM 10 -- Tourists visiting History and Archaeology sites
